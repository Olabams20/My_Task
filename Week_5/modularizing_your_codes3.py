...
Ola = Student("Ola Johnson", "Bio chemistry", 200)
Titi = Student("Titi Micheal", "Accounting", 100)
...
student1 = NigerianStudent("Ayo Daniel", "Lagos", "Street Statistics")
student2 = NigerianStudent("Olamide John", "Ogun", "Mass Communication")
Student3 = NigerianStudent("Esther Shine", "Oyo", "Computer Engineering")
...
kenny = PhoneUser("Kenny Martins", "Glo")
adeola = PhoneUser("Adeola Felix", "9mobile")
...
print(kenny.buy_airtime(1500))          # Kenny now has #1500 airtime
print(adeola.buy_airtime(2000))         # Tolani now has #2000 airtime
