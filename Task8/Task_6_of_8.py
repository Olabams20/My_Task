...
admitted = (score >=200) and unilag_choice and o_level_grades and post_utme
messages = {True: "Congratulations! You're in", False: "Sorry, try again next time!"}
print("Admitted:", admitted)
print("Message:", messages[admitted])